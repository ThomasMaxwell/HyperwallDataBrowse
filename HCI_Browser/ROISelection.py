...
packagePath = os.path.dirname( os.path.dirname( __file__ )  )
defaultMapDir = os.path.join( packagePath, 'config/images' )
    ...
    def mouseReleaseEvent(self, event):
        if event.button() == Qt.RightButton:
            ...
            if self.roiCorner0 != None and self.roiCorner1 != None:
                self.emit( SIGNAL("PointSelected"), self.roiCorner1 )
...
class ROISelectionDialog(QDialog):
    ...
    def __init__(self, parent=None, **args ):
        ...
        self.widget = ROISelectionWidget( self )
        layout = QVBoxLayout()
        layout.addWidget( self.widget )
        self.setLayout(layout)
        
    def setROI( self, roi ):
        self.widget.setROI( roi )
...
class ROISelectionWidget(QWidget):
    ...
    def __init__(self, parent=None, **args ):
        ...
        self.PointLon = QLineEdit( ) 
        self.PointLat = QLineEdit( )
        self.PointLon.setValidator( QDoubleValidator(self) )
        self.PointLat.setValidator( QDoubleValidator(self) )
        ...
        for mapFrame in MapFrames: 
            ...
            self.connect( view, SIGNAL("PointSelected"), self.UpdateGeoCoord )
        ...
        LatLabelp = QLabel( "Lat: ")
        LonLabelp = QLabel( "Lon: ")            
        gridp = QHBoxLayout()
...
class ExampleForm(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.connect(self.roiSelector.widget, SIGNAL('doneConfigure()'), self.setRoi )
